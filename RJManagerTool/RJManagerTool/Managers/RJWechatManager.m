...
{
    if (_delegate && [_delegate respondsToSelector:@selector(responseOnReq:)]) {
                     ...
                     Scene:(enum WXScene)scene
{
    ...
    //    free(pBuffer);
    WXMediaMessage *message = [WXMediaMessage sendAppContentData:nil
                                                           Title:title
                                                         extInfo:extInfo
                                                             Url:url
    ...
    SendMessageToWXReq *req = [SendMessageToWXReq SendMessageText:nil
                                                          Message:message
                                                            bText:NO
                                                            Scene:scene];
...
+(void)sendAppContentText:(NSString *)text
                    Scene:(enum WXScene)scene
{
    SendMessageToWXReq *req = [SendMessageToWXReq SendMessageText:text
                                                          Message:nil
                                                            bText:YES
                                                            Scene:scene];
    [WXApi sendReq:req completion:^(BOOL success) {
